                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            <select  class="form-control select2" name="identification_type_id"
                                ...
                                <option <?php echo escape_output($customer_information->identification_type_id) == "1" ? 'selected' : '' ?> value="1"><?php echo lang('cedula_fisica'); ?></option>
                                <option <?php echo escape_output($customer_information->identification_type_id) == "2" ? 'selected' : '' ?> value="2"><?php echo lang('cedula_juridica'); ?></option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            <input  autocomplete="off" type="text" name="identification_number" class="form-control"
                                placeholder="<?php echo lang('identification_number'); ?>" value="<?php echo escape_output($customer_information->identification_number); ?>">
                        </div>
