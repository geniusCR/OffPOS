...
$rounding_type = $company_info->pos_total_payable_type;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div id="wrapper" class="m-auto border-2s-e4e5ea br-5 p-15">
        ...
        <div class="text-center">
            ...
            <?php if($company_info->collect_tax == 'Yes'){ ?>
                <p class="pb-7 f-w-900 rgb-71"><?php echo $company_info->tax_title; ?>: <?php echo $company_info->tax_registration_no; ?></p>
            <?php } ?>
        </div>
        ...
        <div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="text-rigth">
                    ...
                    <p class="f-w-500 color-71 font-size-13"> <span class="f-w-600"><?php echo lang('date');?>:</span> <?= date($company_info->date_format, strtotime($sale_object->sale_date ?? '')) ?></p>
                </div>
            </div>
        </div>
        <div class="tharmal_table">
            <table class="table w-100 mt-20">
                ...
                <tfoot>
                    <tr>
                        <th></th>
                        <th colspan="2" class="text-right pr-10"><?php echo lang('total');?> </th>
        ...
        <div class="">
            <div>
                ...
                ?>
                <div class="d-flex justify-content-between">
                    <p class="f-w-600 font-size-13"><?php echo lang('change_amount');?></p>
