    ...
    <div class="box-wrapper">
        <div class="table-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <label><?php echo lang('product_serial_no'); ?> <span class="required_star">*</span></label>
                            <input  autocomplete="off" type="text"  name="product_serial_no" class="form-control" placeholder="<?php echo lang('product_serial_no'); ?>" value="<?php echo set_value('product_serial_no'); ?>">
                        </div>
                        ...
                        <div class="form-group"> 
                            ...
                            <select  class="form-control select2 select2-hidden-accessible op_width_100_p" name="customer_id" id="customer_id">
                                ...
                                <?php foreach ($customers as $customer) { ?>
                                    <option value="<?= escape_output($customer->id).'||'. escape_output($customer->name).'||'. escape_output($customer->phone); ?>" <?php echo set_select('customer_id', escape_output($customer->id).'||'. escape_output($customer->name).'||'. escape_output($customer->phone)); ?>><?php echo escape_output($customer->name) ?> <?php echo $customer->phone ? '(' . escape_output($customer->phone) . ')' : '' ?></option>
                                <?php } ?>
                            </select>
                        </div>  
            ...
            <div class="box-footer">
                ...
                <a href="<?php echo base_url() ?>WarrantyProducts/listWarrantyProduct" class="btn bg-blue-btn">
                    <?php echo lang('back'); ?>
                </a>
            </div>
            <?php echo form_close(); ?> 
