...
<body>
    <div id="wrapper" class="m-auto border-2s-e4e5ea br-5 p-15">
        ...
        <div>
            <h4 class="pb-7 font-size-15"><?php echo lang('bill_to');?>: </h4>
            <div class="d-flex justify-content-between">
                <div>
                    <?php if($customer_info->name != ''){ ?>
                    <p class="f-w-500 color-71 font-size-13"><span class="f-w-600"><?php echo lang('name');?>:</span> <?php echo escape_output($customer_info->name) ?></p>
                    <?php } ?>
                ...
                <div class="text-rigth">
                    <p class="f-w-500 color-71 font-size-13"> <span class="f-w-600"><?php echo lang('date');?>:</span> <?= dateFormat($servicing_details->added_date) ?></p>
                </div>
            </div>
        </div>
            ...
            <table class="table w-100 mt-20">
                <thead class="br-3">
                    <tr>
                        ...
                        <th class="w-20"><?php echo lang('servicing_charge');?></th>
