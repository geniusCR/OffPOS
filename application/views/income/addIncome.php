...
<?php
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('add_income'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('income'), 'secondSection'=> lang('add_income')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        <div class="table-box">
            <?php echo form_open(base_url('Income/addEditIncome')); ?>
            <div class="box-body">
                <div class="row">
